package ch.jorisda.nestling.agent.ui.theme
...
private val NestlingTypography = Typography().let { base ->
    base.copy(
...
@Composable
fun NestlingTheme(content: @Composable () -> Unit) {
    ...
    MaterialTheme(colorScheme = colors, typography = NestlingTypography, content = content)
}
