...
import ch.jorisda.nestling.agent.power.FakePowerStatus
...
class AgentUiStateTest {
    ...
    private fun read(
        ...
        settings = FakeAgentSettings(
            baseUrl = if (paired) "https://nestling.test" else null,
    ...
    fun `granting the exemption clears the hint on the next read`() {
        ...
        val settings = FakeAgentSettings(baseUrl = "https://nestling.test", deviceToken = "t")
